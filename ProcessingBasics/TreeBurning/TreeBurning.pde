...
void setup() {
   ...
   *ANSWER HERE: ratio of ROWS to height and COLS to width should be the sam,e
   */
   ...
   *ANSWER : replace squareSize = width/COLS; with the correct square size.
...
void draw() {
   ...
   *ANSWER HERE: This will make 6 ticks happen every second instead of 60, but also allows the window to be refreshed at the old rate of 60 times/s
   */
